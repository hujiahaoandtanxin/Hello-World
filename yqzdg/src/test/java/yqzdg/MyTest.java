...
public class MyTest {
	...
	@Test
	public void selectBusinessAndOrder() {
		List<BusinessType> orderList = businessTypeService.selectOrderByBusinessType("灯具维修");
		Gson gson = new Gson();
		String json = gson.toJson(orderList);
		System.out.println(json);
		System.out.println(orderList.get(0).getOrderList().size());
	}
	
	@Test
	public void selectWiremanOrder() {
		List<Wireman> list1 = wiremanService.selectWiremanAllByOpenid("o4kLT5BGeid_7NY25XyUvRjrAQNE","1");
		Gson gson = new Gson();
